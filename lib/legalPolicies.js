...
export const LEGAL_POLICIES = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'After a completed test and review, we provide the record through the delivery method agreed with you. Issued e-cards include a QR code and confirm code so a school or employer can verify the record without a public name search. Our target is two business days, not a guaranteed same-day service. We will explain a material delay that we know about. Identity questions, incomplete information, or quality review may delay issuance. The E-Card and Records Policy governs copies, corrections, retention, verification, and sharing.',
  ...
  },
  {
    ...
    summary:
      'What an e-card documents, copies, corrections, three-year storage, QR verification, and organization access.',
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'An issued e-card includes a QR code and confirm code that open our verification page. Anyone with that code can confirm whether a matching Secure Fit record is on file and whether it is still within its listed expiration, without a public name search. The public page shows name, dates, result, respirator, tester, and location. It does not show date of birth or email.',
          'Verification uses a random token, not a guessable identifier. Listing every verification record is not allowed. A sample card on this website is not a valid record. Scan only a card we issued after a real test. Record authenticity does not mean a workplace respiratory-protection program is complete.',
        ],
      },
    ],
  },
